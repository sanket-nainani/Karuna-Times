    ...
    <>
      ...
      <div id="KarunaTimes" className="partner">
        ...
        >
          <div className="hero-img-container-inner container">
            <div className="content-box">
              <h5 className="one-rem-mt bold title">Submit Marketing and Partnership Opportunities</h5>
              ...
              <div className=" one-rem-mt ">
                <Link href="/contact">
                  <a href="/contact" className="btn btn-primary  has-box-shadow padding-btn" role="button">
                    Contact Us
                  </a>
                </Link>
              </div>
        ...
        <div className="inner container">
          <h6 className="one-rem-mt bold">Submit Marketing and Partnership Opportunities</h6>
          <p>
